...
const ROOM_META = {
    null: {
        path: '/',
        title: 'Durvankur — Creative 3D Portfolio',
        description: 'Interactive 3D developer portfolio by Tomasz "DURVANKUR" Szmajda. Explore WebGL experiments, React projects & GSAP animations in a hand-drawn gallery.',
    },
    about: {
        path: '/about',
        title: 'About Me — DURVANKUR Portfolio',
        description: 'Learn about Tomasz "DURVANKUR" Szmajda — a creative frontend developer specializing in 3D web experiences, React, Three.js, and GSAP animations.',
    },
    gallery: {
        path: '/gallery',
        title: 'Gallery & Projects — DURVANKUR Portfolio',
        description: 'Browse the interactive 3D gallery of web development projects by DURVANKUR. Each project is displayed as a hand-drawn card you can flip and explore.',
    },
    studio: {
        path: '/studio',
        title: 'The Studio — DURVANKUR Portfolio',
        description: 'Explore DURVANKUR\'s content studio — YouTube videos, blog posts, and TikToks displayed on floating monitors in an immersive 3D space.',
    },
    contact: {
        path: '/contact',
...
export function useDocumentMeta() {
    ...
    useEffect(() => {
        ...
        if (ogUrl) ogUrl.setAttribute('content', `https://DURVANKURdev.com${meta.path}`);

        // Update canonical link to ensure virtual routes are correctly indexable as separate pages
        const canonicalTag = document.querySelector('link[rel="canonical"]');
        if (canonicalTag) {
            canonicalTag.setAttribute('href', `https://DURVANKURdev.com${meta.path}`);
        }
